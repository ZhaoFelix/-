...
//  WeiXin
//
//  Created by Felix on 2019/7/9.
//  Copyright © 2019 apple. All rights reserved.
//

import UIKit
import WebKit
class TodayWeatherViewController: UIViewController,WKUIDelegate,WKNavigationDelegate {
    var progressView = UIProgressView()
    var webView:WKWebView!
    override func viewDidLoad() {
        super.viewDidLoad()
        let url = URL(string: "https://xw.tianqi.qq.com")
